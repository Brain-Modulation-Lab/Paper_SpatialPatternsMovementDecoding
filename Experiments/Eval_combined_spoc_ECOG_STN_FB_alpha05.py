...
#%%
settings = {}
settings['data_path'] = "/mnt/Nexus3/Paper_code_repository/VPeterson_SpatialFilters_2021/Data/Epoched_data/"
settings['out_path_process'] = "/home/PARTNERS/vp820/media/Nexus3/Paper_code_repository/VPeterson_SpatialFilters_2021/Scripts/Results/Multimodal/100ms/alpha05/Gamma/"
    ...
    for ss in range(len(subfolder)):
        ...
        for l, mov in enumerate(laterality):
            ...
            for train_index, test_index in cv.split(label):
                ...
                clf, optimizer = get_model(USED_MODEL, x=dat_tr, y=Ztr, distri='gamma')
        ...
        out_path_file = os.path.join(settings['out_path_process']+ settings['num_patients'][s]+ 'combined_predictions_modelGLM'+'_'+str(subfolder[ss])+'.npy')
